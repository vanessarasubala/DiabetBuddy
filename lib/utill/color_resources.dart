...
class ColorResources {
  ...
  static const Color COLOR_BLACK = Color(0xFF1D1617);
  ...
  static const Color COLOR_GREY_BUNKER = Color(0xffC3CDD6);
  // static Color COLOR_GREY_BUNKER = HexColor("#C3CDD6");
  ...
  static const Color PRIMARY_COLOR = Color(0xFF73C3F9);
  static const Color SUCCESS_COLOR = Color(0xFF58BE3F);
  static const Color DANGER_COLOR = Color(0xFFBE3F3F);
  static const Color REGISTER_BTN = Color(0xFF4745AC);
